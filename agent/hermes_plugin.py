...
def register(ctx) -> None:
    ...
    ctx.register_system_prompt_section("personal-finance.rules", prompt, position="after_memory", max_chars=4000)
    ...
    def record_tool_call(tool_name: str = "", result: str = "", **kwargs) -> None:
        ...
        if result:
            print(json.dumps({"component": "personal-finance-agent", "tool": tool_name, "result_bytes": len(result)}, ensure_ascii=False))
