...
export default function AccountsPage() {
  ...
  return <>
    ...
    {editorOpen && <div className="mb-6"><AccountEditor account={editing} onCancel={() => { setEditorOpen(false); setEditing(null); }} onSaved={() => { setEditorOpen(false); setEditing(null); void load(); }} /></div>}
