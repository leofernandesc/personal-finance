...
import { money, monthLabel, numberValue, percent } from "@/lib/utils";
...
export default function BudgetsPage() {
  ...
  return <>
    <PageHeader eyebrow={monthLabel(new Date())} title="Orçamentos" description="Dê um limite intencional para as categorias que mais importam." action={<Button onClick={() => setFormOpen((value) => !value)}><Plus size={17} /> Novo orçamento</Button>} />
