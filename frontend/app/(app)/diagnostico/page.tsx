...
export default function DiagnosticPage() {
  ...
  React.useEffect(() => {
    load();
    window.addEventListener("diagnostic-changed", load);
    return () => window.removeEventListener("diagnostic-changed", load);
  }, [load]);
