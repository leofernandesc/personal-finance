...
export default function TransactionsPage() {
  ...
  return <>
    ...
    {editorOpen && <div className="mb-6"><TransactionEditor accounts={accounts} categories={categories} transaction={editing} timezone={user?.timezone} onCancel={() => { setEditorOpen(false); setEditing(null); }} onSaved={() => { setEditorOpen(false); setEditing(null); void load(); }} /></div>}
