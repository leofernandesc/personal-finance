      ...
      <PageHeader
        ...
        action={(
          <div className="flex flex-wrap gap-2">
            <Button variant="secondary" onClick={() => { setEditing(null); setEditorMode("transfer"); }}>
              <ArrowLeftRight size={16} /> Transferir
            </Button>
            <Button onClick={() => { setEditing(null); setEditorMode("transaction"); }}>
      ...
      <Card className="mb-5 p-4 md:p-5">
        <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
          ...
          <div className="flex items-end gap-2 md:col-span-2 xl:col-span-3">
            <Button variant="secondary" onClick={applyFilters}><Filter size={15} /> Aplicar filtros</Button><Button variant="quiet" onClick={clearFilters}>Limpar</Button>
          </div>
        </div>
      </Card>
